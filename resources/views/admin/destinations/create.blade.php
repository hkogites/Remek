...
@section('title', ($prefix === 'iroda' ? 'Iroda – Új uticél' : 'Admin – Új uticél'))

@section('body')
  <div class="site-section py-5">
    <div class="container">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Új uticél</h1>
      ...
      <div class="card shadow-sm">
        <div class="card-body">
          <form method="POST" action="{{ route($prefix . '.destinations.store') }}">
            @csrf
            <div class="row g-3">
              <div class="col-md-6">
              ...
              <div class="col-md-4">
                ...
                <input type="number" name="price_huf" class="form-control" value="{{ old('price_huf') }}" required>
              </div>
              <div class="col-md-4">
              ...
              <div class="col-md-6">
                ...
                <input type="text" name="image2_path" class="form-control" value="{{ old('image2_path') }}">
              </div>
              <div class="col-md-12">
                <label class="form-label">Részletes URL (opcionális)</label>
                <input type="text" name="detail_url" class="form-control" value="{{ old('detail_url') }}">
              </div>
              <div class="col-12">
                <label class="form-label">Leírás (HTML megengedett)</label>
                <textarea name="leiras" class="form-control" rows="8">{{ old('leiras') }}</textarea>
              </div>
            </div>
