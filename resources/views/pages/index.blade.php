  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-section py-5">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-7">
            <h2 class="font-weight-bold text-black">Nem tudod, hogy hova utazz?<br> Találd meg velünk az ideális úticélod!</h2>
            <p class="text-black">Töltsd ki a kvízünket, és segítünk megtalálni a számodra tökéletes utazást!</p>
          </div>
          <div class="col-md-5">
            <p class="mb-0"><a href="/quiz" class="btn btn-primary text-white py-3 px-4">Kvíz kitöltése</a></p>
          </div>
        </div>
      </div>
    </div>
