          ...
          <div class="col-md-12 text-center">
            @auth
              @if(!empty($isFull) && $isFull)
                <a class="btn btn-secondary disabled d-block mx-auto"
                   href="#"
                   aria-disabled="true"
                   style="pointer-events:none; opacity:0.7; max-width: 240px;">
                  Betelt
                </a>
              @else
                <a class="btn btn-primary d-block mx-auto"
                   href="{{ route('reservations.create', $destination->slug) }}"
                   style="max-width: 240px;">
                  Lefoglalom
                </a>
              @endif
            @else
              <a class="btn btn-outline-primary d-block mx-auto"
                 href="{{ route('login') }}"
                 style="max-width: 240px;">
