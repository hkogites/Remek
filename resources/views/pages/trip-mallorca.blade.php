...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="ftco-blocks-cover-1">
      <div class="site-section-cover overlay" style="background-image: url('/oldal/images/img_2.jpg')">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-5" data-aos="fade-up">
              <span class="text-white d-block mb-4">Price: <strong>190 000 Ft</strong></span>
              <h1 class="mb-3 text-white">Mallorca</h1>
              <p>Fedezze fel velünk a lenyűgöző Mallorcát, a Baleár-szigetek ékkövét! 5 napos, csoportos utazásunkon garantált élmények, csodás tájak és autentikus kultúra várja.</p>
        ...
        <div class="row mt-5 pt-5">
          ...
          <p><b>Mallorcai csoportosutazás – 5 nap / 4 éjszaka</b><hr>
            ...
            <p>3. nap: Kirándulás a Tramuntana-hegységbe<br>
                <ul>
                    <li>Egész napos buszos kirándulás a Tramuntana-hegységbe.</li>
                    <li>Látogatás Valldemossába, Port de Sóllerbe.</li>
                </ul>
            </p><hr>
            ...
            <ul>
                ...
                <li>Fakultatív: akvárium, e-bike túra, borászat látogatás.</li>
            </ul></p><hr>


            <p>5. nap: Hazautazás<br>
            <ul>
                <li>Reggeli, transzfer a repülőtérre, visszautazás Budapestre.</li>
            </ul>
            </p><hr>
