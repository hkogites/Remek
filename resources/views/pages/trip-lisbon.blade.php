...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="ftco-blocks-cover-1">
      <div class="site-section-cover overlay" style="background-image: url('/oldal/images/img_4.jpg')">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-5" data-aos="fade-up">
              <span class="text-white d-block mb-4">Price: <strong>250 000 Ft</strong></span>
              <h1 class="mb-3 text-white">Lisszabon</h1>
              <p>Fedezze fel velünk Lisszabon csodálatos városát, ahol a történelem, a kultúra és a lenyűgöző óceánpart találkozik! 5 napos csoportos utazás.</p>
      ...
      <div class="container">
        ...
        <div class="row mt-5 pt-5">
          <div class="col-md-6">
            ...
            <p>1. nap: Érkezés és városnézés<br>
                <ul>
                    <li>Indulás Budapestről Lisszabonba, transzfer a szállodába.</li>
                    <li>Belém negyed: Jeromos kolostor, Belémi torony, Felfedezők emlékműve.</li>
                </ul>
            </p><hr>

            <p>2. nap: Belváros és Alfama<br>
                <ul>
                    <li>Szent György vár, Alfama, Praça do Comércio.</li>
                </ul>
            </p><hr>

            <p>3. nap: Sintra és Cascais<br>
                <ul>
                    <li>Pena Palota, Regaleira, tengerpart Cascaisnál.</li>
                </ul>
            </p><hr>

            <p>4. nap: Modern Lisszabon<br>
            <ul>
                <li>Parque das Nações, Oceanário.</li>
            </ul></p><hr>
...
<<<<<<< HEAD
          <div class="col-lg-3">
            ...
            <div class="row">
              ...
              <div class="col-4 gal_col">
                <a href="/trips"><img src="/oldal/images/img_2.jpg" alt="Image" class="img-fluid"></a>
              </div>
              <div class="col-4 gal_col">
                <a href="/trips"><img src="/oldal/images/norveg.jpg" alt="Image" class="img-fluid"></a>
              </div>
              <div class="col-4 gal_col">
                <a href="/trips"><img src="/oldal/images/torok.jpg" alt="Image" class="img-fluid"></a>
              </div>
              <div class="col-4 gal_col">
                <a href="/trips"><img src="/oldal/images/img_3.jpg" alt="Image" class="img-fluid"></a>
              </div>
              <div class="col-4 gal_col">
                <a href="/trips"><img src="/oldal/images/img_4.jpg" alt="Image" class="img-fluid"></a>
              </div>
            </div>
          </div>
=======
