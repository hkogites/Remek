...
<html lang="en">
  ...
  <head>
    ...
    <link rel="icon" type="image/x-icon" href="/images/logokicsi.png">
    <meta charset="utf-8">
            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li class="active"><a href="about.html" class="nav-link">Rólunk</a></li>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 order-1" data-aos="fade-left">
            <img src="/oldal/images/banner.png" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="person-29191 text-center">
              <img src="/oldal/images/person_1.jpg" class="img-fluid mb-4">
              <div class="px-4">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="person-29191 text-center">
              <img src="/oldal/images/person_2.jpg" class="img-fluid mb-4">
              <div class="px-4">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="person-29191 text-center">
              <img src="/oldal/images/person_3.jpg" class="img-fluid mb-4">
              <div class="px-4">
